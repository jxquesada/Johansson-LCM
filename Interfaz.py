...
def guardarInfo():
    ...
    hoja1.append(('Material de los bloques del Patrón:', materialPatron.get()))
...
def enviarAlarma():
    ...
    sender_email = "alarma.calibracion@gmail.com"  # Correo del que se envía alarma
    receiver_email = "isela.aley@gmail.com"  # Correo que recibe notificación
    password = "alarmaLCM2021"
    message = """\
    alarma.calibracion
...
materialPatron=Entry(FrameInfo)
materialPatron.place(x=1060, y=130)

Label(FrameInfo, text="Usuario: ").place(x=890, y=180)
Radiobutton(FrameInfo, text="Leonardo Rojas Rapso", variable=escogerUsuario,value=1, command=selectorUsuario).place(x=890, y=200)
Radiobutton(FrameInfo, text="Olman Ramos Alfaro", variable=escogerUsuario,value=2, command=selectorUsuario).place(x=890, y=220)
Radiobutton(FrameInfo, text="Ignacio López Hidalgo", variable=escogerUsuario,value=3, command=selectorUsuario).place(x=890, y=240)
Radiobutton(FrameInfo, text="Luis Chaves Santacruz", variable=escogerUsuario,value=4, command=selectorUsuario).place(x=890, y=260)
Radiobutton(FrameInfo, text="Francisco Sequeira", variable=escogerUsuario,value=5, command=selectorUsuario).place(x=890, y=280)
Radiobutton(FrameInfo, text="Luis Damian Rodriguez", variable=escogerUsuario,value=6, command=selectorUsuario).place(x=890, y=300)
Radiobutton(FrameInfo, text="Marcela Prendas Peña", variable=escogerUsuario,value=7, command=selectorUsuario).place(x=890, y=320)
Radiobutton(FrameInfo, text="Fernando Andrés Monge", variable=escogerUsuario,value=8, command=selectorUsuario).place(x=890, y=340)
Radiobutton(FrameInfo, text="Otro:", variable=escogerUsuario,value=9, command=selectorUsuario).place(x=890, y=360)
nuevoUsuario=Entry(FrameInfo)
nuevoUsuario.place(x=960, y=360)

Label(FrameInfo, text="Revisor: ").place(x=1200, y=180)
Radiobutton(FrameInfo, text="Leonardo Rojas Rapso", variable=escogerRevisor,value=1, command=selectorRevisor).place(x=1200, y=200)
Radiobutton(FrameInfo, text="Olman Ramos Alfaro", variable=escogerRevisor,value=2, command=selectorRevisor).place(x=1200, y=220)
Radiobutton(FrameInfo, text="Ignacio López Hidalgo", variable=escogerRevisor,value=3, command=selectorRevisor).place(x=1200, y=240)
Radiobutton(FrameInfo, text="Luis Chaves Santacruz", variable=escogerRevisor,value=4, command=selectorRevisor).place(x=1200, y=260)
Radiobutton(FrameInfo, text="Francisco Sequeira", variable=escogerRevisor,value=5, command=selectorRevisor).place(x=1200, y=280)
Radiobutton(FrameInfo, text="Luis Damian Rodriguez", variable=escogerRevisor,value=6, command=selectorRevisor).place(x=1200, y=300)
Radiobutton(FrameInfo, text="Marcela Prendas Peña", variable=escogerRevisor,value=7, command=selectorRevisor).place(x=1200, y=320)
Radiobutton(FrameInfo, text="Fernando Andrés Monge", variable=escogerRevisor,value=8, command=selectorRevisor).place(x=1200, y=340)
Radiobutton(FrameInfo, text="Otro:", variable=escogerRevisor,value=9, command=selectorRevisor).place(x=1200, y=360)
nuevoRevisor=Entry(FrameInfo)
nuevoRevisor.place(x=1270, y=360)

ttk.Button(FrameInfo, text='Crear hoja de datos', command=guardarInfo).place(x=1100, y=700) #Boton para crear hoja de datos

ttk.Button(FrameInfo, text='Siguiente', command=irBloques).place(x=1400, y=800)            #Boton para ir a frame de bloques
...
Input_button.pack()
Input_button.place(x=740, y=550)
